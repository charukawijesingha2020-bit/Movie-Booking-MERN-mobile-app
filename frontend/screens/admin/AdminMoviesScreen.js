...
const s = StyleSheet.create({
  ...
  card: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#1a1a1a', borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#2a2a2a' },
  cardLeft: { flex: 1 },
  ...
  inactive: { color: '#E50914', fontSize: 11, marginTop: 2, fontWeight: 'bold' },
  ...
  delBtn: { backgroundColor: '#5a1a1a', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6 },
  ...
  modalCard: { backgroundColor: '#1a1a1a', borderRadius: 18, padding: 20, maxHeight: '90%' },
